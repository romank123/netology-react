...
import FooterSubscribeForm from '../FooterSubscribeForm/FooterSubscribeForm.js';
...
class Footer extends Component {
  ...
  shouldComponentUpdate(nextProps, nextState) {
    if (nextState.isSubscribed === this.state.isSubscribed) return false;
    return true;
  }
        ...
        <section className="subscribe">
          <div className="subscribe__wrapper">
            ...
            {!this.state.isSubscribed ? 
              <FooterSubscribeForm becomeSubscribed={this.becomeSubscribed} /> :
